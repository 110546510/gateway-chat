...
class MMysql {
    ...
    /**
     * 初始化类
     * @param array $conf 数据库配置l
     */

    public function __construct() {
        $conf = require_once __DIR__.'/../database.php';
        class_exists('\PDO') or die("PDO: class not exists.");
        $this->_dbType = $conf['dbType'];
     ...
     * @return array
     */
    protected function _tbFields() {
        $sql = 'SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME="'.$this->_table.'" AND TABLE_SCHEMA="'.$this->_dbName.'"';
